...
def get_minecraft_news() -> MinecraftNews:
    ...
    news = requests.get("https://launchercontent.mojang.com/news.json", headers=headers).json()
...
def get_java_patch_notes() -> JavaPatchNotes:
    ...
    return requests.get("https://launchercontent.mojang.com/javaPatchNotes.json", headers=headers).json()
